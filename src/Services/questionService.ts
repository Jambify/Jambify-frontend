...
export const LIKELY_TOPICS: Record<string, string[]> = {
  ...
  Mathematics: ["Algebra", "Geometry", "Arithmetic", "Statistics & Probability", "Calculus"],
  Physics: [
    "Mechanics",
    "Thermal Physics",
    "Waves & Optics",
  ...
  Biology: [
    ...
    "Nutrition & Digestion",
    "Human Physiology (Transport & Respiration)",
  ...
  Economics: [
    ...
    "Labour & Population Economics",
    "National Income & Macroeconomics",
    "Money, Banking & Monetary Policy",
    "Public Finance",
    "International Trade & Organizations",
    "Development Economics & Economic Systems",
    "Agricultural, Environmental & Resource Economics",
    "Statistics & Consumer Behaviour",
  ],
  Government: [
    "Nigerian Government & Constitutions",
    "Systems & Arms of Government",
  ...
  Literature: [
    "Literary Principles & Appreciation",
    "Poetry",
    "Prose",
    "Drama",
    "Othello",
