...
export const privacyPolicyContent: LegalBlock[] = [
  ...
  { type: "p", text: "If you subscribe to a paid plan, payment is handled by a third-party payment processor, Flutterwave. Schooldra does not directly collect or store your full card number, CVV, or bank login details — these are entered directly into the processor's secure system. We receive and store limited transaction information such as payment status, plan purchased, amount, and transaction reference, for the purpose of managing your subscription." },

  { type: "h2", text: "2.5 Technical and Usage Data" },
  { type: "p", text: "We may automatically collect device type, browser type, IP address, general location (city/country level), app usage patterns, and error/crash logs, to help us maintain and improve Schooldra." },
  ...
  { type: "p", text: "To exercise any of these rights, contact us at support@schooldra.com. We will respond within a reasonable timeframe as required by applicable law." },

  { type: "h1", text: "10. Cookies and Similar Technologies" },
  { type: "p", text: "Schooldra may use local storage and cookies to keep you logged in, remember your preferences, and understand how the app is used. You can control cookies through your browser settings, though some features may not work properly if you disable them." },

  { type: "h1", text: "11. Third-Party Links" },
  { type: "p", text: "Schooldra may contain links to third-party websites or services (e.g. official JAMB resources). We are not responsible for the privacy practices of these third parties, and we encourage you to review their policies separately." },
...
export const termsOfServiceContent: LegalBlock[] = [
  ...
  { type: "p", text: "Schooldra provides practice quizzes, mock exams, performance tracking, and study group features to help you prepare for JAMB/UTME. Schooldra is an independent exam-preparation tool and is not affiliated with, endorsed by, or operated by the Joint Admissions and Matriculation Board (JAMB) or any government body." },

  { type: "h1", text: "3. Subscriptions and Payment" },
  { type: "h2", text: "3.1 Plans" },
  { type: "p", text: "Schooldra offers both free and paid subscription plans. Paid plans may unlock additional features such as offline practice packs, extended mock exams, or advanced analytics, as described on our pricing page within the app at the time of purchase." },
  ...
  { type: "p", text: "When using Schooldra, you agree not to:" },
  { type: "bullet", text: "Share your account with others or allow multiple people to use one paid subscription" },
  { type: "bullet", text: "Attempt to scrape, copy, redistribute, or resell Schooldra's question bank or content" },
  ...
  { type: "p", text: "Study group chat messages and any other content you post within Schooldra (\u201cUser Content\u201d) remain your responsibility. You grant Schooldra a limited license to store and transmit your User Content solely to operate the study group feature (e.g. delivering your messages to other group members). We may remove User Content that violates these Terms or applicable law." },

  { type: "h1", text: "6. Intellectual Property" },
  { type: "p", text: "All questions, explanations, branding, design, software, and other content provided by Schooldra (excluding User Content) are owned by or licensed to Schooldra and are protected by copyright and other intellectual property laws. You may use this content only for your personal, non-commercial exam preparation, and may not copy, distribute, or create derivative works from it without our written permission." },

  { type: "h1", text: "7. No Guarantee of Exam Results" },
  { type: "p", text: "Schooldra is a study aid designed to support your preparation. We do not guarantee any specific JAMB/UTME score, admission outcome, or exam result from using the app. Your results depend on many factors outside our control, including your own effort, official exam conditions, and JAMB's own policies and question formats." },

  { type: "h1", text: "8. Disclaimers" },
  { type: "p", text: "Schooldra is provided \u201cas is\u201d and \u201cas available,\u201d without warranties of any kind, whether express or implied, including but not limited to warranties of merchantability, fitness for a particular purpose, or non-infringement. We do not warrant that the app will be uninterrupted, error-free, or completely secure." },

  { type: "h1", text: "9. Limitation of Liability" },
  { type: "p", text: "To the maximum extent permitted by Nigerian law, Schooldra and its operators shall not be liable for any indirect, incidental, special, or consequential damages, including loss of data, loss of profits, or exam-related outcomes, arising from your use of or inability to use the app. Our total liability for any claim relating to Schooldra shall not exceed the amount you paid us in the twelve (12) months preceding the claim." },

  { type: "h1", text: "10. Termination" },
  { type: "p", text: "You may stop using Schooldra and delete your account at any time. We may suspend or terminate your account, with or without notice, if we reasonably believe you have violated these Terms, engaged in fraudulent activity, or misused the platform. Upon termination, your right to use Schooldra ends immediately, though certain provisions of these Terms (e.g. intellectual property, limitation of liability) will continue to apply." },

  { type: "h1", text: "11. Changes to These Terms" },
  { type: "p", text: "We may update these Terms from time to time to reflect changes in our service or legal requirements. We will update the \u201cEffective Date\u201d above and, for material changes, notify you via the app or email. Continued use of Schooldra after changes take effect constitutes your acceptance of the updated Terms." },

  { type: "h1", text: "12. Governing Law" },
  { type: "p", text: "These Terms are governed by the laws of the Federal Republic of Nigeria. Any disputes arising from these Terms or your use of Schooldra shall be subject to the exclusive jurisdiction of the courts of Nigeria." },
