...
export const ENGLISH_QUESTIONS: Question[] = [
  {
    ...
    answer: 1,
    explanation:
      '"Verbose" means using more words than necessary — in other words, wordy.',
  },
  {
    ...
    answer: 1,
    explanation:
      'With "neither…nor", the verb agrees with the subject closest to it. Here "the teacher" is singular, so "was" is correct.',
  },
  {
  ...
  },
  {
    ...
    answer: 1,
    explanation:
      'The past perfect continuous "had been painting" is used for an action that was ongoing up to a point in the past.',
  },
  {
  ...
  },
  {
    ...
    answer: 2,
    explanation:
      'In subjunctive mood (hypothetical situations), "were" is used for all persons.',
  },
];
