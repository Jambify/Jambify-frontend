...
export const CHEMISTRY_QUESTIONS: Question[] = [
  {
    ...
    answer: 0,
    explanation:
      "Sodium has 11 electrons distributed as 2 in the first shell, 8 in the second, and 1 in the third — giving 2, 8, 1.",
  },
  {
  ...
  },
  {
    ...
    answer: 0,
    explanation:
      "Molar mass of CO₂ = 12 + (16x2) = 44g/mol. Moles = mass / molar mass = 22 / 44 = 0.5 moles.",
  },
];
