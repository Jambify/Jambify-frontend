  ...
  return (
    <>
      <button
        ...
        className={cn(
          "text-textDim hover:text-danger flex items-center gap-1.5 rounded-lg px-2.5 py-1.5 text-[11px] font-semibold transition-colors",
          className,
        )}
      ...
      {open && (
        <div className="fixed inset-0 z-[70] flex items-center justify-center p-4">
          ...
          />
          <div className="bg-bgCard border-borderMuted relative z-10 w-full max-w-sm rounded-2xl border p-5 shadow-2xl">
            {submitted ? (
