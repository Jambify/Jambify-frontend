    ...
    <div className="bg-bgCard border border-borderMuted rounded-brand-lg p-5">
      ...
      <div className="space-y-0.5">
            ...
            >
              <span
                className={cn(
                  ...
                  RANK_STYLES[entry.rank] ?? "text-textDim",
                )}
              >
                {entry.rank}
              </span>
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-[11px] text-textDim truncate">
                  {entry.school}
                </p>
              </div>
        ...
        <div className="flex items-center gap-2.5 px-2.5 py-2 rounded-brand bg-brand/10 border border-brand/20">
          <span className="text-xs font-mono w-4 text-center text-brand-light">
            {schoolRank}
          </span>
          ...
          <div className="flex-1 min-w-0">
            <p className="text-sm font-semibold truncate">
              {name}{" "}
              <span className="text-[10px] bg-brand text-white px-1.5 py-0.5 rounded-full ml-1">
                You
              </span>
            </p>
          </div>
          <span className="font-mono text-sm font-medium text-brand-light">
            267
          </span>
        </div>
      </div>
