      ...
      <div className="min-h-screen bg-bgMain text-textMain flex items-center justify-center p-4">
        <div className="bg-bgCard border border-borderMuted rounded-[32px] p-8 w-full max-w-md text-center shadow-2xl">
          ...
          <p className="text-textMuted text-sm mb-6 leading-relaxed">
            Pay <strong className="text-textMain">{CURRENCY}{DISPLAY_PRICE}</strong> to unlock Pro.
          ...
          <div className="bg-bgSurface border border-borderMuted rounded-2xl p-4 mb-6 text-left space-y-2">
            <p className="text-xs text-textDim uppercase tracking-widest font-bold mb-3">Payment Steps</p>
            <div className="flex items-start gap-2 text-sm text-textMuted">
              <span className="w-5 h-5 rounded-full bg-brand/10 text-brand text-[10px] flex items-center justify-center shrink-0 mt-0.5 font-bold">1</span>
              <span>Send <strong className="text-textMain">{CURRENCY}{DISPLAY_PRICE}</strong> via bank transfer or Flutterwave</span>
            </div>
            <div className="flex items-start gap-2 text-sm text-textMuted">
              <span className="w-5 h-5 rounded-full bg-brand/10 text-brand text-[10px] flex items-center justify-center shrink-0 mt-0.5 font-bold">2</span>
              <span>Copy your transaction reference number</span>
            </div>
            <div className="flex items-start gap-2 text-sm text-textMuted">
              <span className="w-5 h-5 rounded-full bg-brand/10 text-brand text-[10px] flex items-center justify-center shrink-0 mt-0.5 font-bold">3</span>
      ...
      <div className="bg-bgCard border border-borderMuted rounded-[32px] p-8 w-full max-w-md text-center shadow-2xl backdrop-blur-md">
        ...
        <div className="space-y-3 mb-8">
          {[
            ...
            <div key={feat} className="flex items-center gap-3 text-left bg-bgSurface border border-borderMuted rounded-2xl p-3">
