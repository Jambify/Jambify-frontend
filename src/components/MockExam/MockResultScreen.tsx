...
const MockResultsScreen: React.FC<MockResultsProps> = ({ onRetry, onHome }) => {
  ...
  if (!isPro) {
    return <ExamPaywall onUpgrade={() => {}} onBack={onHome} />;
  }
    ...
    <div className="max-w-2xl mx-auto animate-fadeIn">
      ...
      <div className="relative bg-bgCard border border-borderMuted rounded-brand-xl p-8 text-center mb-5 overflow-hidden">
        <div
          ...
          style={{
            background:
              "radial-gradient(circle at 50% 0%, rgba(91,59,255,0.08) 0%, transparent 65%)",
          }}
        />
      ...
      <div className="grid grid-cols-3 gap-3 mb-5">
        {[
          ...
          >
            <div className={cn("font-display text-2xl font-bold", color)}>
              {value}
            </div>
      ...
      <div className="bg-bgCard border border-borderMuted rounded-brand-lg p-5 mb-5">
        <h3 className="font-display text-sm font-semibold tracking-tight mb-4">
          Subject breakdown
        </h3>
