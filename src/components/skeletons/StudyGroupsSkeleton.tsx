  ...
  <div>
    <div className="mb-6 flex flex-col justify-between gap-4 sm:flex-row sm:items-end">
      <div className="space-y-2">
        <div className="bg-bgSurface skeleton-shimmer h-8 w-44 rounded" />
    ...
    <div className="mb-5 grid grid-cols-1 gap-4 md:grid-cols-2">
      <div className="bg-bgCard rounded-lg p-4">
        <div className="bg-bgSurface skeleton-shimmer mb-2 h-3 w-24 rounded" />
        <div className="flex gap-2">
          <div className="bg-bgSurface skeleton-shimmer h-9 flex-1 rounded-lg" />
          <div className="bg-bgSurface skeleton-shimmer h-9 w-16 rounded-lg" />
        </div>
      </div>
      <div className="bg-bgCard flex flex-col justify-end rounded-lg p-4">
        <div className="bg-bgSurface skeleton-shimmer mb-2 h-3 w-32 rounded" />
        <div className="bg-bgSurface skeleton-shimmer h-9 w-full rounded-lg" />
      </div>
    </div>

    <div className="bg-bgSurface mb-4 flex w-fit gap-1 rounded-lg p-1">
      {[1, 2].map((t) => (
        <div key={t} className="bg-bgCard skeleton-shimmer h-8 w-40 rounded-md" />
      ))}
    </div>
    ...
    <div className="no-scrollbar mb-5 flex gap-2 overflow-x-auto pb-1">
      {[1, 2, 3, 4].map((c) => (
        <div
          key={c}
          className="bg-bgSurface skeleton-shimmer flex h-8 w-28 shrink-0 items-center gap-1.5 rounded-lg px-3"
        >
          <div className="bg-bgCard skeleton-shimmer h-3 w-3 rounded" />
          <div className="bg-bgCard skeleton-shimmer h-3 w-14 rounded" />
        </div>
      ))}
    </div>

    <div className="bg-bgSurface skeleton-shimmer mb-3 h-4 w-44 rounded" />
