  ...
  <div className="animate-fadeIn mx-auto max-w-350 space-y-6">
    <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
      <div className="space-y-2">
        <div className="bg-bgSurface skeleton-shimmer h-9 w-56 rounded lg:h-11" />
        <div className="bg-bgSurface skeleton-shimmer h-4 w-72 rounded lg:h-5" />
      </div>
      <div className="flex flex-col gap-3">
        <div className="flex items-center gap-3">
          <div className="bg-bgSurface skeleton-shimmer h-9 w-32 rounded-full" />
          <div className="bg-bgSurface skeleton-shimmer h-8 w-44 rounded-full" />
        </div>
      </div>
    </div>
    ...
    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4 lg:gap-6">
      {[1, 2, 3, 4].map((i) => (
        ...
        >
          <div className="bg-bgSurface skeleton-shimmer mb-5 flex h-14 w-14 items-center justify-center rounded-2xl shadow-sm" />
          <div className="bg-bgSurface skeleton-shimmer mb-1.5 h-5 w-40 rounded" />
          <div className="mb-auto min-h-14">
            <div className="bg-bgSurface skeleton-shimmer mt-1 h-10 w-24 rounded lg:h-11" />
          </div>
    ...
    <div className="grid grid-cols-1 gap-8 lg:grid-cols-12">
      ...
      <div className="space-y-6 lg:col-span-5 xl:col-span-4">
        <div className="group bg-bgCard relative flex h-full flex-col overflow-hidden rounded-2xl p-6 shadow-sm lg:p-8">
          <div className="bg-bgSurface skeleton-shimmer absolute top-0 right-0 -mt-32 -mr-32 h-64 w-64 rounded-full blur-3xl" />
          ...
          <div className="bg-bgSurface/40 relative z-10 mt-8 rounded-2xl p-6 lg:p-7">
            ...
            <div className="bg-bgCard skeleton-shimmer h-5 overflow-hidden rounded-full p-1.5">
    ...
    <div className="space-y-6 pt-4">
      <div className="flex items-center justify-between">
        ...
        <div className="bg-bgSurface/50 skeleton-shimmer mx-6 hidden h-px flex-1 md:block" />
      </div>
