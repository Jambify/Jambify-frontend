...
const SubjectGridSkeleton: React.FC = () => (
  <div className="animate-fadeIn mx-auto max-w-350 space-y-6">
    <div className="space-y-2">
      <div className="bg-bgSurface skeleton-shimmer h-9 w-48 rounded" />
      <div className="bg-bgSurface skeleton-shimmer h-4 w-64 rounded" />
    </div>

    <div className="flex items-center gap-2">
      <div className="bg-bgSurface skeleton-shimmer h-11 flex-1 rounded-full" />
      <div className="bg-bgSurface skeleton-shimmer h-11 w-24 rounded-full" />
    </div>
