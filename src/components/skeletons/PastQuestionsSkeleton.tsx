...
const PastQuestionsSkeleton: React.FC = () => (
  <div className="mx-auto max-w-5xl space-y-6 py-6">
    <div className="flex animate-pulse flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
      <div>
        <div className="mb-1 flex items-center gap-2">
          <div className="bg-bgSurface h-8 w-44 rounded lg:h-9 lg:w-52" />
          <div className="bg-bgSurface h-5 w-12 rounded-full" />
        </div>
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="bg-bgSurface h-9 w-36 rounded-full" />
      </div>
    </div>

    <div className="bg-bgCard animate-pulse space-y-4 rounded-2xl p-5">
    ...
    <div className="flex animate-pulse items-center justify-between pt-2">
