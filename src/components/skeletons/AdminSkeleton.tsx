  ...
  <div className="space-y-6 p-6">
    <div className="flex items-center justify-between">
      ...
      <div className="flex gap-2">
        <div className="bg-bgSurface skeleton-shimmer h-9 w-28 rounded-lg" />
        <div className="bg-bgSurface skeleton-shimmer h-9 w-24 rounded-lg" />
      </div>
    </div>
    ...
    <div className="bg-bgCard rounded-2xl p-6">
      <div className="mb-6 flex items-center justify-between">
        <div className="bg-bgSurface skeleton-shimmer h-6 w-44 rounded" />
        <div className="bg-bgSurface skeleton-shimmer h-9 w-72 rounded-lg" />
      </div>
      <div className="overflow-x-auto">
        <div className="min-w-full">
          ...
          <div className="bg-bgSurface skeleton-shimmer mb-2 h-px w-full" />
          {[1, 2, 3, 4, 5].map((r) => (
            <div key={r} className="flex items-center py-4">
              {[1, 2, 3, 4, 5, 6].map((c) => (
                <div key={c} className="flex-1">
                  <div
                    className={`bg-bgSurface skeleton-shimmer h-4 rounded ${
