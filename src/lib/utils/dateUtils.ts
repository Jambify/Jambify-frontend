 ...
 */
export function parseExamDate(examDateStr: string, examYear: string): Date | null {
 ...
 */
export function calculateDaysUntilExam(examDateStr: string, examYear: string): number {
