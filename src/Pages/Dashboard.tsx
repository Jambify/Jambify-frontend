...
const Dashboard: React.FC = () => {
  ...
  const isNewUser    = questionsCompleted === 0 && overallScore === 0;
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 mb-6">
        ...
        <div className="bg-bgCard border border-borderMuted rounded-brand-xl p-4 md:p-5 flex flex-col gap-2">
          ...
          {overallScore > 0 ? (
            ...
            <>
              <p className="font-display text-2xl font-black tracking-tight text-textDim">—</p>
              <p className="text-[11px] text-textDim leading-snug">Complete a quiz to start</p>
            </>
          )}
        </div>
        ...
        <div className="bg-bgCard border border-borderMuted rounded-brand-xl p-4 md:p-5 flex flex-col gap-2">
          ...
          {questionsCompleted > 0 ? (
            ...
            <>
              <p className="font-display text-2xl font-black tracking-tight text-textDim">—</p>
              <p className="text-[11px] text-textDim leading-snug">Take your first quiz</p>
            </>
          )}
        </div>
        ...
        <div className="bg-bgCard border border-borderMuted rounded-brand-xl p-4 md:p-5 flex flex-col gap-2">
          ...
          <p className={cn(
            ...
            questionsCompleted > 0 ? "text-3xl text-textMain" : "text-2xl text-textDim"
          )}>
          ...
          {questionsCompleted > 0 ? (
            ...
            <p className="text-[11px] text-textDim leading-snug">Start practising</p>
          )}
        </div>
        ...
        <div className="bg-bgCard border border-borderMuted rounded-brand-xl p-4 md:p-5 flex flex-col gap-2">
          <div className="flex items-center justify-between">
            ...
            <div className={cn(
              ...
              <Flame className={cn("w-4 h-4", streak > 0 ? "text-orange-400" : "text-textDim")} />
            </div>
          </div>
          {streak > 0 ? (
            <>
            ...
            <>
              <p className="font-display text-2xl font-black tracking-tight text-textDim">0</p>
              <p className="text-[11px] text-textDim leading-snug">Start your streak today</p>
            </>
          )}
        </div>
      </div>
